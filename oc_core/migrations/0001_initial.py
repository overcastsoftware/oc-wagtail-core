...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='StandardPage',
            fields=[
                ('page_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='wagtailcore.Page', on_delete=django.db.models.deletion.SET_NULL)),
                ('intro', fields.RichTextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_document', models.ForeignKey(related_name='+', blank=True, to='wagtaildocs.Document', null=True, on_delete=django.db.models.deletion.SET_NULL)),
                ('link_page', models.ForeignKey(related_name='+', blank=True, to='wagtailcore.Page', null=True, on_delete=django.db.models.deletion.SET_NULL)),
                ('page', modelcluster.fields.ParentalKey(related_name='related_links', to='oc_core.StandardPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.AddField(
            model_name='standardindexpagerelatedlink',
            name='page',
            field=modelcluster.fields.ParentalKey(related_name='related_links', to='oc_core.StandardIndexPage'),
        ),
    ]
